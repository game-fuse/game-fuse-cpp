...
{
    APIRequestManager::CompletionCallback.BindDynamic(this, &UGameFuseUser::InternalResponseManager);
...
void UGameFuseUser::SetAttributeLocal(const FString& SetKey, const FString& SetValue, FGameFuseAPIResponseCallback CompletionCallback)
{
    ...
    APIRequestManager::CompletionCallback.Execute(true, Set_Dirty_Attribute_Message);
}

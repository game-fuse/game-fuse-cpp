...
public:
    // Create a new group
    FGuid CreateGroup(const FGFGroup& Group, const FGFApiCallback& Callback);
    ...
    FGuid GetAllGroups(const FGFApiCallback& Callback);
    FGuid RequestToJoinGroup(int32 GroupId, const FGFApiCallback& Callback);
}; 
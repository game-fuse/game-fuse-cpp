...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "GameFuse|User")
	void PurchaseStoreItem(const FGFStoreItem& StoreItem, FGameFuseAPIResponseCallback CompletionCallback);

	UFUNCTION(BlueprintCallable, Category = "GameFuse|User")
	void RemoveStoreItemWithId(const int StoreItemId, FGameFuseAPIResponseCallback CompletionCallback);

	UFUNCTION(BlueprintCallable, Category = "GameFuse|User")
	void RemoveStoreItem(const FGFStoreItem& StoreItem, FGameFuseAPIResponseCallback CompletionCallback);
